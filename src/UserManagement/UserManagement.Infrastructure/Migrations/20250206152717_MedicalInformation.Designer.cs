...
namespace UserManagement.Infrastructure.Migrations
{
    ...
    [Migration("20250206152717_MedicalInformation")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UserManagement.Domain.AggregatesModel.UserAggregate.Allergy", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("UserManagement.Domain.AggregatesModel.UserAggregate.AllergySeverity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("UserManagement.Domain.AggregatesModel.UserAggregate.Disease", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("UserManagement.Domain.AggregatesModel.UserAggregate.MedicalConditionStatus", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("UserManagement.Domain.AggregatesModel.UserAggregate.Medicine", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("UserManagement.Domain.AggregatesModel.UserAggregate.AllergyImpact", b =>
                {
                    b.HasOne("UserManagement.Domain.AggregatesModel.UserAggregate.Allergy", "Allergy")
                        .WithMany()
                    ...
                    b.HasOne("UserManagement.Domain.AggregatesModel.UserAggregate.AllergySeverity", "Severity")
                        .WithMany()
            ...
            modelBuilder.Entity("UserManagement.Domain.AggregatesModel.UserAggregate.MedicalCondition", b =>
                {
                    b.HasOne("UserManagement.Domain.AggregatesModel.UserAggregate.Disease", "Disease")
                        .WithMany()
                    ...
                    b.HasOne("UserManagement.Domain.AggregatesModel.UserAggregate.MedicalConditionStatus", "Status")
                        .WithMany()
            ...
            modelBuilder.Entity("UserManagement.Domain.AggregatesModel.UserAggregate.Medication", b =>
                {
                    ...
                    b.HasOne("UserManagement.Domain.AggregatesModel.UserAggregate.Medicine", "Medicine")
                        .WithMany()
