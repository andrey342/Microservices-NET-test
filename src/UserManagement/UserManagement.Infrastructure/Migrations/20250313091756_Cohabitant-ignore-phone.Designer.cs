...
namespace UserManagement.Infrastructure.Migrations
{
    ...
    [Migration("20250313091756_Cohabitant-ignore-phone")]
    partial class Cohabitantignorephone
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UserManagement.Domain.AggregatesModel.ContractAggregate.Cohabitant", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("UserManagement.Domain.AggregatesModel.ContractAggregate.Contract", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("UserManagement.Domain.AggregatesModel.ContractAggregate.Masters.CohabitantType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("UserManagement.Domain.AggregatesModel.ContractAggregate.Masters.ContractStatus", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("UserManagement.Domain.AggregatesModel.ContractAggregate.Masters.KeyStatus", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("UserManagement.Domain.AggregatesModel.ContractAggregate.Masters.ServiceType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("UserManagement.Domain.AggregatesModel.ContractAggregate.Residence", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ContractId", "IsCurrentResidence")
                        .IsUnique()
            ...
            modelBuilder.Entity("UserManagement.Domain.AggregatesModel.ContractAggregate.Cohabitant", b =>
                {
                    b.HasOne("UserManagement.Domain.AggregatesModel.ContractAggregate.Masters.CohabitantType", "CohabitantType")
                        .WithMany()
                        .HasForeignKey("CohabitantTypeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("UserManagement.Domain.AggregatesModel.ContractAggregate.Residence", "Residence")
            ...
            modelBuilder.Entity("UserManagement.Domain.AggregatesModel.ContractAggregate.Contract", b =>
                {
                    b.HasOne("UserManagement.Domain.AggregatesModel.ContractAggregate.Masters.ContractStatus", "CurrentStatus")
                        .WithMany()
                        .HasForeignKey("CurrentStatusId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("UserManagement.Domain.AggregatesModel.ContractAggregate.Masters.ServiceType", "ServiceType")
                        .WithMany()
            ...
            modelBuilder.Entity("UserManagement.Domain.AggregatesModel.ContractAggregate.Residence", b =>
                {
                    b.HasOne("UserManagement.Domain.AggregatesModel.ContractAggregate.Contract", "Contract")
                        .WithMany("Residences")
