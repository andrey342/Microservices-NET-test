...
namespace UserManagement.Infrastructure.Migrations
{
    ...
    [Migration("20250416112244_cohabitant-bool")]
    partial class cohabitantbool
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PersonalResource", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("PersonalResource");
                });

            modelBuilder.Entity("UserManagement.Domain.AggregateModel.WorkCenterAggregate.Area", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("AreaLevelId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("UserManagement.Domain.AggregateModel.WorkCenterAggregate.AreaLevel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("WorkCenterId", "Level")
                        .IsUnique();

                    b.ToTable("AreaLevel");
                });

            modelBuilder.Entity("UserManagement.Domain.AggregatesModel.ServiceContractAggregate.CentralUnit", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("UserManagement.Domain.AggregatesModel.ServiceContractAggregate.Key", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("UserManagement.Domain.AggregatesModel.ServiceContractAggregate.KeyHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("UserManagement.Domain.AggregatesModel.ServiceContractAggregate.Peripheral", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("ServiceContractCentralUnitId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("Id");

                    b.HasIndex("ServiceContractCentralUnitId");
            ...
            modelBuilder.Entity("UserManagement.Domain.AggregatesModel.ServiceContractAggregate.ServiceContractBeneficiary", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ServiceContractId", "UserId")
                        .IsUnique();

                    b.ToTable("ServiceContractBeneficiary");
                });

            modelBuilder.Entity("UserManagement.Domain.AggregatesModel.ServiceContractAggregate.ServiceContractCentralUnit", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("CentralUnitId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("CentralUnitId", "ServiceContractId")
                        .IsUnique();

                    b.ToTable("ServiceContractCentralUnits");
                });
            ...
            modelBuilder.Entity("UserManagement.Domain.AggregatesModel.UserAggregate.MedicalInformation", b =>
                {
                    ...
                    b.Property<Guid?>("DependencyDegreeId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<int?>("LawtonIndex")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("PhysicalScaleBSN")
                        .HasColumnType("int");

                    b.Property<int?>("PhysicalScaleBVD")
                        .HasColumnType("int");

                    b.Property<int?>("PsychologicalScaleBSN")
                        .HasColumnType("int");

                    b.Property<int?>("PsychologicalScaleBVD")
                        .HasColumnType("int");

                    b.Property<int?>("SocialScaleBSN")
                        .HasColumnType("int");

                    b.Property<int?>("SocialScaleBVD")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("DependencyDegreeId");
            ...
            modelBuilder.Entity("UserManagement.Domain.AggregatesModel.UserAggregate.WorkCenterResource", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("WorkCenterResource");
                });

            modelBuilder.Entity("UserManagement.Domain.AggregatesModel.WorkCenterAggregate.Resource", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("PersonalResource", b =>
                {
                    ...
                    b.OwnsOne("UserManagement.Domain.ValueObjects.PhoneNumbers", "PhoneNumbers", b1 =>
                        {
                            b1.Property<Guid>("PersonalResourceId")
                                .HasColumnType("uniqueidentifier");
                            ...
                            b1.HasKey("PersonalResourceId");

                            b1.ToTable("PersonalResource");

                            b1.WithOwner()
                                .HasForeignKey("PersonalResourceId");
                        });
            ...
            modelBuilder.Entity("UserManagement.Domain.AggregateModel.WorkCenterAggregate.Area", b =>
                {
                    b.HasOne("UserManagement.Domain.AggregateModel.WorkCenterAggregate.AreaLevel", "AreaLevel")
                        .WithMany("Areas")
                        .HasForeignKey("AreaLevelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("UserManagement.Domain.AggregateModel.WorkCenterAggregate.Area", "Parent")
                        .WithMany("Childrens")
                        .HasForeignKey("ParentId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.Navigation("AreaLevel");
            ...
            modelBuilder.Entity("UserManagement.Domain.AggregatesModel.ServiceContractAggregate.Key", b =>
                {
                    b.HasOne("UserManagement.Domain.AggregatesModel.ServiceContractAggregate.Masters.KeyStatus", "CurrentStatus")
                        .WithMany()
            ...
            modelBuilder.Entity("UserManagement.Domain.AggregatesModel.ServiceContractAggregate.KeyHistory", b =>
                {
                    b.HasOne("UserManagement.Domain.AggregatesModel.ServiceContractAggregate.Key", "Key")
                        .WithMany("KeyHistories")
                        .HasForeignKey("KeyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("UserManagement.Domain.AggregatesModel.ServiceContractAggregate.Masters.KeyStatus", "KeyStatus")
                        .WithMany()
            ...
            modelBuilder.Entity("UserManagement.Domain.AggregatesModel.ServiceContractAggregate.Peripheral", b =>
                {
                    b.HasOne("UserManagement.Domain.AggregatesModel.ServiceContractAggregate.ServiceContractCentralUnit", "ServiceContractCentralUnit")
                        .WithMany("Peripherals")
                        .HasForeignKey("ServiceContractCentralUnitId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.Navigation("ServiceContractCentralUnit");
                });
            ...
            modelBuilder.Entity("UserManagement.Domain.AggregatesModel.ServiceContractAggregate.ServiceContractBeneficiary", b =>
                {
                    ...
                    b.HasOne("UserManagement.Domain.AggregatesModel.UserAggregate.User", "User")
                        .WithMany("ServiceContractsBeneficiary")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("UserManagement.Domain.AggregatesModel.ServiceContractAggregate.ServiceContractCentralUnit", b =>
                {
                    b.HasOne("UserManagement.Domain.AggregatesModel.ServiceContractAggregate.CentralUnit", "CentralUnit")
                        .WithMany("ServiceContractCentralUnits")
                        .HasForeignKey("CentralUnitId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("UserManagement.Domain.AggregatesModel.UserAggregate.MedicalInformation", b =>
                {
                    b.HasOne("UserManagement.Domain.AggregatesModel.UserAggregate.Masters.DependencyDegree", "DependencyDegree")
                        .WithMany()
                        .HasForeignKey("DependencyDegreeId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.Navigation("DependencyDegree");
                });
            ...
            modelBuilder.Entity("UserManagement.Domain.AggregatesModel.UserAggregate.WorkCenterResource", b =>
                {
                    b.HasOne("UserManagement.Domain.AggregatesModel.WorkCenterAggregate.Resource", "Resource")
                        .WithMany()
            ...
            modelBuilder.Entity("UserManagement.Domain.AggregatesModel.ServiceContractAggregate.CentralUnit", b =>
                {
                    b.Navigation("ServiceContractCentralUnits");
                });
            ...
            modelBuilder.Entity("UserManagement.Domain.AggregatesModel.UserAggregate.User", b =>
                {
                    b.Navigation("PersonalResources");

                    b.Navigation("ServiceContractsBeneficiary");

                    b.Navigation("UserAnimals");

                    b.Navigation("UserHistories");

                    b.Navigation("WorkCenterResources");
                });
